...
<section class="section" id="categories">
    <div class="section-inner">
        ...
        <div class="cat-grid">
            <a href="<?php echo e(auth()->check() ? '/app' : '/login'); ?>" class="cat-card">
...
<footer>
    ...
    <div class="footer-bottom">
        <span>© <?php echo e(date('Y')); ?> VeilleSci Burkina — Tous droits réservés</span>
        <span>🇧🇫 Fait avec ❤️ au Burkina Faso</span>
    </div>
</footer>

</body>
</html><?php /**PATH C:\laragon\www\VeilleSci\resources\views/welcome.blade.php ENDPATH**/ ?>